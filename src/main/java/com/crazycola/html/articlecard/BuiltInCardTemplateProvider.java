    ...
    public static CardTemplate editorialDark() {
        return new CardTemplate(
                ...
                Map.ofEntries(
                        ...
                        Map.entry("subheadline-size", "29px"),
                        Map.entry("item-title-size", "34px"),
                        Map.entry("body-size", "25px"),
                        Map.entry("summary-size", "25px"),
                        Map.entry("item-gap", "20px"),
                        Map.entry("item-padding", "27px"),
                        Map.entry("font-family-body", "ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Microsoft YaHei,sans-serif"),
                        Map.entry("font-family-display", "ui-serif,Georgia,STSong,Songti SC,serif")),
    ...
    public static CardTemplate warmPaper() {
        return new CardTemplate(
                ...
                Map.ofEntries(
                        ...
                        Map.entry("radius", "18px"),
                        Map.entry("page-padding-x", "84px"),
                        Map.entry("page-padding-y", "86px"),
                        Map.entry("headline-size", "70px"),
                        Map.entry("subheadline-size", "28px"),
                        Map.entry("item-title-size", "31px"),
                        Map.entry("body-size", "24px"),
                        Map.entry("summary-size", "24px"),
                        Map.entry("item-gap", "22px"),
                        Map.entry("item-padding", "28px"),
                        Map.entry("font-family-body", "ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Microsoft YaHei,sans-serif"),
                        Map.entry("font-family-display", "ui-serif,Georgia,STSong,Songti SC,serif")),
    ...
    public static CardTemplate neoGrid() {
        return new CardTemplate(
                ...
                Map.ofEntries(
                        ...
                        Map.entry("summary-size", "24px"),
                        Map.entry("item-gap", "18px"),
                        Map.entry("item-padding", "24px"),
                        Map.entry("font-family-body", "ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Microsoft YaHei,sans-serif"),
                        Map.entry("font-family-display", "ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Microsoft YaHei,sans-serif")),
